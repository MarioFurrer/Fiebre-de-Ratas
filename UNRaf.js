class UNRaf extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.audio("sonidoTrigo", "./assets/audio/Cosechar.mp3");
        this.load.audio("ubicarGato", "./assets/audio/GatoUbicar.mp3");
        this.load.audio("ataqueGato", "./assets/audio/GatoAtaque.mp3");
